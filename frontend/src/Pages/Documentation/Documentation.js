...
render(){
    ...
    <ListGroup>
        ...
        <ListGroup.Item> File Structure for this submission is as follows</ListGroup.Item> 
        <ListGroup.Item> ProjectFolder -> docker-compose.yml app -> Dockerfile </ListGroup.Item>
    </ListGroup>
